...
const EventPLuser = () => {
  ...
  }, [dispatch, page, limit, gameName, eventName, marketName]);
      ...
      <div className='px-[15px] md:px-[30px]'>
        ...
        <div className='border border-gray-300 bg-white'>
          <div className='bg-dark px-2.5 py-[5px] text-white'>
            <h2 className='text-[15px] font-bold'>Profit Loss User</h2>
          </div>
                  ...
                  {!loading && PLdata?.length > 0 ? (
                    PLdata.map((item, index) => (
                      <tr key={index} className='text-center hover:bg-gray-100'>
                        <td
                          className='cursor-pointer border border-gray-300 p-2 text-[#2789ce] lowercase'
                          onClick={() => {
                            const itemGameName =
